...
const Home = () => {
  return (
    <div className="w-[60%] mx-auto">
      ...
      <div className="p-6 rounded-lg my-12 flex items-center justify-between bg-gradient-to-l from-slate-100 to-slate-300 shadow-lg shadow-blue-400">
        ...
        <div className="p-6 space-y-12 rounded-lg mb-4 bg-gradient-to-r from-slate-100 to-slate-300 border-2 border-slate-400 shadow-lg shadow-blue-400">
            <h2 className=" font-bold text-2xl mb-4 ">Knowledge in Web Development</h2>

          <p className="text-lg text-gray-700">
            Recently completed the{" "}
            <span class="font-semibold">Complete Web Development Course</span>{" "}
            from
            <span className="font-semibold">Programming Hero</span>, an online
            web development learning platform run by
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-600">
            ...
            <li>
              ...
              Firebase Authentication, Node JS, Express, MongoDB, JSON Web
              Token, and usage of various plugins to make web development faster
              and easier)
            </li>
          </ul>
        </div>
          ...
          <div class="space-y-4">
            <div>
              ...
              <p class="text-gray-600">
                Company: TexElegant – Swedish Readymade Garments trading
                company.
              </p>
            </div>
          ...
          <table class="min-w-full bg-white border border-gray-200 mt-4">
            <thead>
              <tr class="bg-gray-100 border-b">
                <th class="text-left py-3 px-4 text-gray-700">Exam Title</th>
                <th class="text-left py-3 px-4 text-gray-700">
                  Concentration/Major
                </th>
                <th class="text-left py-3 px-4 text-gray-700">Institute</th>
                <th class="text-left py-3 px-4 text-gray-700">Pass Year</th>
              </tr>
            </thead>
            <tbody>
              <tr class="border-b">
                ...
                <td class="py-3 px-4 text-gray-600">Accounting</td>
                <td class="py-3 px-4 text-gray-600">University of Dhaka</td>
                <td class="py-3 px-4 text-gray-600">1989</td>
              </tr>
              <tr>
                <td class="py-3 px-4 text-gray-600">
                ...
                <td class="py-3 px-4 text-gray-600">Accounting</td>
                <td class="py-3 px-4 text-gray-600">University of Dhaka</td>
                <td class="py-3 px-4 text-gray-600">1988</td>
              </tr>
            </tbody>
          </table>
        </div>
        
        <div className="h-12 bg-gradient-to-l from-slate-100 to-slate-300 my-8 rounded-lg">
